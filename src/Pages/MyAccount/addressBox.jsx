...
const AddressBox = (props) => {
  ...
  return (
    <div
      className="group relative border border-dashed border-blue-200 addressBox w-full bg-[#fafafa] 
    ...
    >
      ...
      <span className="pt-0 text-[13px] block w-100">
        {`${props?.address.address_line1} ${props?.address.city} ${props?.address.country} 
